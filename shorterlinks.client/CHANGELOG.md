...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest shorterlinks.client -- --template=react`.
- Создание файла проекта (`shorterlinks.client.esproj`).
